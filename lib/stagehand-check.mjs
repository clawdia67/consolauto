...
export async function initStagehand() {
  ...
  if (cookies.length > 0) {
    await stagehand.page.context().addCookies(cookies);
...
async function screenshot(name) {
  ...
  await stagehand.page.screenshot({ path: file, fullPage: true });
...
export async function checkSlots() {
  ...
  // Bump timeout — site is congested at midnight
  ...
  page.setDefaultTimeout(30_000); // reset
